            ...
            <div className="p-6 md:p-8">
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  className="w-full bg-transparent resize-none outline-none text-lg md:text-xl text-white placeholder:text-zinc-600 leading-relaxed"
                />
...
{showPreview && previewHTML && (
  <div className="fixed inset-0 z-[999] bg-black/80 backdrop-blur-xl flex flex-col">
